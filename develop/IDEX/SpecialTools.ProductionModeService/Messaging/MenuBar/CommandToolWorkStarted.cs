...
namespace SpecialTools.ProductionModeService.Messaging.MenuBar
{
    ...
    /// <summary>
    /// Message Klasse um zu verarbeiten, dass ein Tool gerade die Berechnungen gestartet hat
    /// </summary>
    [AutoRegisterMessage]
    [PublicAPI]
    public sealed class CommandToolWorkStarted : IMessage
    {
        /// <summary>

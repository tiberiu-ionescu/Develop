...
namespace SpecialTools.ProductionModeService.Messaging.ProductionMode.Responses
{
    ...
    /// <summary>
    /// Ergebnis des Lesens des Produktionsmodus
    /// </summary>
    [AutoRegisterMessage]
    [PublicAPI]
    public sealed class ReadProductionModeResult : IResponse
    {
        ///<inheritdoc/>
        ...
        /// <summary>
        /// Erstellt ein Ergebnis zum Lesen des Produktionsmodus
        /// </summary>
        public ReadProductionModeResult(List<EcuProductionModeState> aCurrentStatus, ProductionModeState aOverallStatus)
        {
        ...
        public ReadProductionModeResult()
        {
        }
    }
}

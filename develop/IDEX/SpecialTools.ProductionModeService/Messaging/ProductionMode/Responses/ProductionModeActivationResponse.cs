...
namespace SpecialTools.ProductionModeService.Messaging.ProductionMode.Responses
{
    ...
    /// <summary>
    /// Ergebnis des Aktivierens des Produktionsmodus
    /// </summary>
    [AutoRegisterMessage]
    [PublicAPI]
    public sealed class ProductionModeActivationResponse : IResponse
    {
        ///<inheritdoc/>
        ...
        /// <summary>
        /// Erstellt ein Ergebnis zum Aktivieren des Produktionsmodus
        /// </summary>
        public ProductionModeActivationResponse(List<EcuProductionModeState> aCurrentStatus, ProductionModeState aOverallStatus)
        {
        ...
        public ProductionModeActivationResponse()
        {
        }
    }
}

...
namespace SpecialTools.ProductionModeService.Messaging.ToolInfo
{
    ...
    [AutoRegisterMessage]
    [PublicAPI]
    public sealed class ResultDisplayToolName : IMessage
    {
        /// <summary>
        /// Wird genutzt um das Tool für den Anwender identifizierbar zu machen. 
        /// Kann bei Bedarf auch durch das Tool selbst lokalisiert ausgegeben werden.
        /// </summary>
        public string DisplayToolName { get; set; }
